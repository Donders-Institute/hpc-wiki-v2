# -*- coding: utf-8 -*-
#
# HPC wiki documentation build configuration file, created by
...
#html_css_files = ['https://media.readthedocs.org/css/sphinx_rtd_theme.css','https://media.readthedocs.org/css/readthedocs-doc-embed.css','_static/theme_overrides.css']
#html_context = {
#    'css_files': [
...
man_pages = [
    (master_doc, 'hpcwiki', u'HPC wiki Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'HPCwiki', u'HPC wiki Documentation',
     author, 'HPCwiki', 'One line description of project.',
     'Miscellaneous'),
]
