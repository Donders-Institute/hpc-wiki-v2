...
.. note::
    Some applications, such as Matlab, do not support the Nvidia MIG (GPU partitioning) fully.  If you need to avoid job being assigned to a patitioned GPU, you could use the `--constraint=nomig`.  For example,
