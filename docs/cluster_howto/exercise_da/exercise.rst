...
You will be given a dataset (with fake data) and an analysis algorithm implemented in various languages/tools.  Your task is to run the analysis over the dataset in parallel using the slurm cluster.
